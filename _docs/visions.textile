...
One big aha in our evolution was when we "realized":http://blog.crisp.se/2010/05/08/henrikkniberg/1273272420000 that Crisp itself is just a platform. Crisp doesn't have a Vision (with a Big V), we just want Crisp to be a "nice home for consultants":what-is-leanintuit.html.
...
* We bring this poster to our conferences, so we keep iterating on it (just like our two A3s "What is Leanintuit":what-is-leanintuit.html and "How we work":how-leanintuit-works.html).
