...
The solution is _load balancing_ - having a group of trusted colleagues that you can send clients to and receive clients from. And that's exactly what Crisp is - a bunch of trusted colleagues! 
...
Nope. If you pass a client on to a colleague, you won't earn a provision or finder's fee or anything like that. Why? Because the underlying "purpose of Crisp":what-is-leanintuit.html is not to maximize profit, it is to maximize "happiness":happiness-index.html. We earn money from our clients, not from each other.
...
No formal powers at all! Although, like with all Crispers, there's plenty of _informal power_ to go around :o)
