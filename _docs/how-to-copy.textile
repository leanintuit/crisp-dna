...
No worries, once you've forked it you can remove the stuff you don't need. The gist of our model is summarized in "What is Crisp":what-is-crisp.html and "How Leanintuit Works":how-leanintuit-works.html, so you might decide to just keep those two (but with your company name).
