...
To maintain a "happy home":what-is-leanintuit.html with mutual respect, we've agreed on this compromise:

# Crisp doesn't work with industries that at least one Crisper has a strong opinion against (currently Arms and Surveillance).
# If someone really wants to take on such a client, they must do so outside of Crisp. 

h2. How do we decide which industries are blacklisted?

If you are _strongly_ against any specific industry, bring it up at the next "unconference":unconference.html (or better yet, before joining Crisp). The decision boils down to how much you hate that industry vs how much others love it :o)
...
h2. What happens when a client from these industries “knocks on the door”?
